...
void detectAndDisplay(Mat frame)
{
...

	{
		...
		stringstream ssfn;
		filename = "D:\\UIT\\First Year\\Second sem\\C++\\Face Recognition Project\\Faces\\";
...
void addFace()
{
	...
	if (!face_cascade.load("D:\\UIT\\First Year\\Second sem\\C++\\C++ project 2\\opencv\\sources\\data\\haarcascades_cuda\\haarcascade_frontalface_alt.xml"))
	{
		cout << "error" << endl;
		return;
	};
